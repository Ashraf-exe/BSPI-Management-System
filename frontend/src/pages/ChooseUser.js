  ...
  const navigateHandler = (user) => {
    if (user === "Admin") {
      if (visitor === "guest") {
        ...
        const email = "ashrafhossen8600@gmail.com";
         const password = "ashraf8700";
      ...
      if (visitor === "guest") {
        ...
        const rollNum = "884596";
        const studentName = "ashraf";
         const password = "ashraf8700";
      ...
      if (visitor === "guest") {
        ...
        const email = "Tarek00@gmail.com";
         const password = "tarek123";
        const fields = { email, password };
        setLoader(true);
        dispatch(loginUser(fields, user));
      } else {
